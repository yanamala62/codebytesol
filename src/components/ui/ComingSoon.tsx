...
export default function ComingSoon({ title, subtitle, icon = 'ri-rocket-line' }: ComingSoonProps) {
  return (
    <PageLayout title={title}>
      ...
      <section className="w-full bg-gradient-to-br from-[#00C896]/10 via-white to-[#00D9FF]/10 py-32 px-6 lg:px-16">
        <div className="flex flex-col items-center text-center">
          <div className="w-24 h-24 flex items-center justify-center bg-gradient-to-br from-[#00C896] to-[#00D9FF] rounded-2xl mb-8 shadow-lg shadow-[#00C896]/30">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              to="/"
              className="px-8 py-4 bg-gradient-to-r from-[#00C896] to-[#00D9FF] text-white font-semibold rounded-lg hover:shadow-xl hover:shadow-[#00C896]/40 transition-all duration-300 flex items-center gap-2 justify-center"
            >
              <i className="ri-home-line" /> Back to Home
            </Link>
            <Link
              to="/contact"
              className="px-8 py-4 border-2 border-[#00C896] text-[#00C896] font-semibold rounded-lg hover:bg-[#00C896] hover:text-white transition-all duration-300 flex items-center gap-2 justify-center"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          {[
            ...
            <div key={card.title} className="flex flex-col items-center p-8 bg-gray-50 rounded-2xl hover:shadow-md transition-shadow duration-300">
              <div className="w-14 h-14 flex items-center justify-center bg-gradient-to-br from-[#00C896]/10 to-[#00D9FF]/10 rounded-xl mb-4">
                <i className={`${card.icon} text-3xl text-[#00C896]`} />
              </div>
