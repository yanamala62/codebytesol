        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              Press <span className="bg-gradient-to-r from-[var(--color-primary-500)] to-[var(--color-accent-500)] bg-clip-text text-transparent">Contact</span>
            </h1>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="mb-16 space-y-8">
            ...
            <div className="bg-white rounded-3xl p-10 shadow-xl border border-gray-100">
              <div className="flex items-start gap-4 mb-6">
                <div className="w-16 h-16 flex items-center justify-center bg-gradient-to-br from-[var(--color-primary-500)] to-[var(--color-accent-500)] rounded-2xl flex-shrink-0">
            ...
            <div className="bg-white rounded-3xl p-10 shadow-xl border border-gray-100">
              <div className="flex items-start gap-4 mb-6">
                <div className="w-16 h-16 flex items-center justify-center bg-gradient-to-br from-[var(--color-accent-500)] to-[var(--color-primary-500)] rounded-2xl flex-shrink-0">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            {/* Media Inquiries */}
            <div className="bg-white rounded-3xl p-10 shadow-xl border border-gray-100">
              <div className="w-16 h-16 flex items-center justify-center bg-gradient-to-br from-[var(--color-primary-500)] to-[var(--color-accent-500)] rounded-2xl mb-6">
              ...
              <div className="space-y-3">
                <a href="mailto:info@forgebyte.ai" className="flex items-center gap-3 text-gray-700 hover:text-[var(--color-primary-500)] transition-colors cursor-pointer">
                  <i className="ri-mail-line text-xl"></i>
                  info@forgebyte.ai
                </a>
                <a href="tel:+18121010266" className="flex items-center gap-3 text-gray-700 hover:text-[var(--color-primary-500)] transition-colors cursor-pointer">
            ...
            <div className="bg-white rounded-3xl p-10 shadow-xl border border-gray-100">
              <div className="w-16 h-16 flex items-center justify-center bg-gradient-to-br from-[var(--color-accent-500)] to-[var(--color-primary-500)] rounded-2xl mb-6">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-12 text-white text-center mb-12">
            <div className="w-20 h-20 flex items-center justify-center bg-gradient-to-br from-[var(--color-primary-500)] to-[var(--color-accent-500)] rounded-full mx-auto mb-6">
          ...
          <div className="bg-white rounded-3xl p-10 shadow-xl border border-gray-100">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-12 h-12 flex items-center justify-center bg-[var(--color-primary-500)]/10 rounded-full mx-auto mb-3">
                  <i className="ri-map-pin-line text-2xl text-[var(--color-primary-500)]"></i>
                </div>
